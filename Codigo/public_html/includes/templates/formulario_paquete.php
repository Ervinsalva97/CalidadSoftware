        ...
        <div class="flex-2">
            <div class="mb-3">
                ...
                <input type="number" name="paquete[cantidad]" id="cantidad" class="form-control" value="<?php echo $paquete->cantidad ?>">
            </div>
            <div class="mb-3">
                <label for="precio">Precio</label>
                <input type="number" name="paquete[precio]" id="precio" class="form-control" value="<?php echo $paquete->precio ?>">
            </div>
        </div>
        <div class="flex-2">
            <div class="mb-3">
