            ...
            <div class="descripcion">
                ...
                <div class="button-container">
                    ...
                    <form action="carrito/carritoAccion.php" method="post">
                        ...
                        <label class="text-dark">Cantidad de personas</label>
                        ...
                        <button type='submit' name="btnAccion" value="agregar" class="btn-solid-reg page-scroll">Agregar a Carrito || $./<?php echo $subtotal; ?></button>
